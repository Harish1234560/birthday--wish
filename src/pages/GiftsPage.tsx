...
const gifts = [
  { id: 1, emoji: '🎁', message: 'A surprise adventure awaits you!', color: 'from-primary to-accent' },
  { id: 2, emoji: '💝', message: 'A day of pampering and relaxation!', color: 'from-secondary to-primary' },
  { id: 3, emoji: '🌟', message: 'Your dreams are about to come true!', color: 'from-accent to-secondary' },
];
