    ...
    <div className="min-h-screen overflow-hidden relative">
      ...
      <main className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
        ...
        >
          ...
          >
            Another year older, another year more awesome! Thanks for all the crazy memories, late-night talks, and laughs. Let’s make this year even more unforgettable 😎🥳  !Click the button and unlock the birthday surprise!
          </motion.p>
